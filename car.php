...
if(!empty($carID) && !empty($result)) {
    $discounted = "<span>Már napi&nbsp;<b>$result->price €</b></span>";
    $stars = "";

    if($result->discount > 0) $discounted = "<del><small>Már napi&nbsp;<b>$result->price €</b></small></del><span>Már napi&nbsp;<b>".number_format((double)$result->price - ((double)$result->price * (double)$result->discount / 100), 2)." €</b></span>";
