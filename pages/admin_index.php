...
<div class="container" style="margin-top: 3rem">
    ...
    <button type='submit' form='update_status_$value->ordersID-form' class='button w-100 p-2'>Rendelés elfogadása</button>
    <button type='submit' form='update_status_$value->ordersID-form' class='button-2 w-100 p-2' >Rendelés elutasítása</button></div></div></div>";
                    }
